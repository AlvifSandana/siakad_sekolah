    ...
    public function run()
    {
        ...
        for ($i=1; $i <= 20; $i++) {
            DB::table('siswa')->insert([
                ...
                'nama_lengkap' => $faker->name($jk),
                'kota_lahir' => $faker->city,
                'tanggal_lahir' => $faker->date('Y-mm-dd'),
                'agama_siswa' => $agama,
                'jenis_kelamin'=> $jk,
                ...
                'nama_wali' => $faker->name($jk),
                'alamat_wali' => $faker->address,
                'no_hp_wali' => $faker->phoneNumber,
                'kelas_id' => $faker->numberBetween(0, 10),
                'tahun_ajaran_id' => $faker->numberBetween(0, 10),
